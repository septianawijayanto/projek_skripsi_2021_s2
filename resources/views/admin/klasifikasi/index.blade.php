                ...
                <div class="modal-body">
                    <form id="form-tambah-edit" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                            ...
                            <input name="kode_klasifikasi" id="kode_klasifikasi" required type="text" class="form-control"
                                placeholder="Input Koda klasifikasi" value="">
                        </div>
                        <div class="form-group ">
                            <label for="exampleFormControlInput1">Nama klasifikasi</label>
                            <input name="nama_klasifikasi" id="nama_klasifikasi" required type="text" class="form-control"
                                placeholder="Input Nama klasifikasi" value="">
                        </div>
